...
Fields **1..7 and 13..15 are payday's**; an app adds its own in 8..12 and from
16. An overlay that redeclares a number payday owns is refused: protobuf-merge
takes the overlay's word, so `alias` would quietly become whatever it said.
