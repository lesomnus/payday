...
| [Commands on your binary](guide/commands.md) | `get`/`ls`/`watch`/`add`/`patch`/`erase` where the schema declared them, the output formats, and a command for an RPC of your own |
