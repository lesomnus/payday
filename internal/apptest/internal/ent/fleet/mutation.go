...
// Mutation represents an operation that mutates the Fleet nodes in the graph.
...
// NewMutation creates a new Mutation for the Fleet entity.
...
func (m *Mutation) Predicates() []predicate.Fleet {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Fleet) {
