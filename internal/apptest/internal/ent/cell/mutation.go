...
// Mutation represents an operation that mutates the Cell nodes in the graph.
...
// NewMutation creates a new Mutation for the Cell entity.
...
func (m *Mutation) Predicates() []predicate.Cell {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Cell) {
