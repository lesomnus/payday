...
func (_c *CellCreate) sqlSave(ctx context.Context) (*Cell, error) {
	...
	if _spec.Id.Value != nil {
		...
		if !ok {
			sv = cell.ValueScanner.Id.ScanValue()
			if err := sv.Scan(_spec.Id.Value); err != nil {
				return nil, err
			}
		}
		if value, err := cell.ValueScanner.Id.FromValue(sv); err != nil {
			return nil, err
		} else {
			_node.Id = value
		}
...
func (_c *CellCreate) createSpec() (*Cell, *sqlgraph.CreateSpec, error) {
	var (
		...
		func(i int, root context.Context) {
			...
			var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
				...
				if specs[i].Id.Value != nil {
					...
					if id, err := cell.ValueScanner.Id.FromValue(sv); err != nil {
						return nil, err
					} else {
						nodes[i].Id = id
					}
