...
func (_c *RobotCreate) sqlSave(ctx context.Context) (*Robot, error) {
	...
	if _spec.Id.Value != nil {
		...
		if !ok {
			sv = robot.ValueScanner.Id.ScanValue()
			if err := sv.Scan(_spec.Id.Value); err != nil {
				return nil, err
			}
		}
		if value, err := robot.ValueScanner.Id.FromValue(sv); err != nil {
			return nil, err
		} else {
			_node.Id = value
		}
...
func (_c *RobotCreate) createSpec() (*Robot, *sqlgraph.CreateSpec, error) {
	var (
		...
		func(i int, root context.Context) {
			...
			var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
				...
				if specs[i].Id.Value != nil {
					...
					if id, err := robot.ValueScanner.Id.FromValue(sv); err != nil {
						return nil, err
					} else {
						nodes[i].Id = id
					}
