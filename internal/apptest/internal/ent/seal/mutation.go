...
// Mutation represents an operation that mutates the Seal nodes in the graph.
...
// NewMutation creates a new Mutation for the Seal entity.
...
func (m *Mutation) Predicates() []predicate.Seal {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Seal) {
