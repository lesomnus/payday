...
// Mutation represents an operation that mutates the Joint nodes in the graph.
...
// NewMutation creates a new Mutation for the Joint entity.
...
func (m *Mutation) Predicates() []predicate.Joint {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Joint) {
