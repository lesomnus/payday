...
import (
	...
	_ "github.com/lesomnus/payday/internal/apptest/internal/ent/runtime"
...
func migrateSchema(t TestingT, c *ent.Client, o *options) {
	...
	if err := migrate.Create(context.Background(), migrate.NewSchema(c.Driver()), tables, o.migrateOpts...); err != nil {
		t.Error(err)
		t.FailNow()
	}
}
