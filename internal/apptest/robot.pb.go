...
const file_app_robot_proto_rawDesc = "" +
	"\n" +
	"\x0fapp/robot.proto\x12\x03app\x1a\x13payday/tenant.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\x1a\fpayday.proto\"\xbb\x02\n" +
	"\x05Robot\x12\x1b\n" +
	...
	"\fdate_created\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampB\t\xea\x82\x16\x05@\x01\x82\x01\x00R\vdateCreated:\x84\x01\xca\xfc\x15G\x12\x02\x10\x01\x1a \x12\x04page\x1a\x10\n" +
	...
	"\fdate_created\n" +
	"\x04\n" +
	"\x02id\x12\x06tenant\x1a\x03ref 2(d\"\b\n" +
	"\x06tenant\"\x84\x01\n" +
	"\x05Joint\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\fB\v\xea\x82\x16\a\x10@(\x01\x82\x01\x00R\x02id\x12(\n" +
