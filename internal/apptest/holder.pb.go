...
const file_payday_holder_proto_rawDesc = "" +
	"\n" +
	"\x13payday/holder.proto\x12\x06payday\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\x1a\fpayday.proto\x1a\x13payday/tenant.proto\"\xb6\x04\n" +
	"\x06Holder\x12\x1b\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:9\xca\xfc\x15%\x12\x02\x10\x01\x1a\x1f\x12\x04slug\x1a\t\n" +
	"\x05alias\x10\x04\x1a\n" +
	"\n" +
	"\x06tenant\x10\x020\x01\x8a\xbb\x16\f\b\x02\"\b\n" +
