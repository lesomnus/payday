...
type AuditServiceServer struct {
	...
	apptest.UnimplementedAuditServiceServer
}
...
func NewAuditServiceServer(db *ent.Client, opts ...Option) apptest.AuditServiceServer {
...
func (s AuditServiceServer) Add(ctx context.Context, req *apptest.AuditAddRequest) (*apptest.Audit, error) {
	...
	if err := record(ctx, s.Rec, st.Db, Change{
		By:  apptest.AuditService_Add_FullMethodName,
		Key: u.Id,
	}); err != nil {
		return nil, err
	}
...
func (s AuditServiceServer) Get(ctx context.Context, req *apptest.AuditGetRequest) (*apptest.Audit, error) {
...
func AuditSelectedFields(m *apptest.AuditSelect) []string {
	if m.GetAll() {
...
func AuditSelect(q *ent.AuditQuery, m *apptest.AuditSelect) {
	if !m.GetAll() {
...
func AuditSelectInit(q *ent.AuditQuery, m *apptest.AuditSelect) {
	if m != nil {
		AuditSelect(q, m)
	} else {
	}
...
func (s AuditServiceServer) Patch(ctx context.Context, req *apptest.AuditPatchRequest) (*apptest.Audit, error) {
	...
	return s.apply(ctx, req.GetRef(), doc, apptest.AuditService_Patch_FullMethodName)
}

func AuditGetKey(ctx context.Context, db *ent.Client, ref *apptest.AuditRef) (uuid.UUID, error) {
	var z uuid.UUID
	if ref.HasId() {
...
func (s AuditServiceServer) Apply(ctx context.Context, req *apptest.AuditApplyRequest) (*apptest.Audit, error) {
	...
	return s.apply(ctx, req.GetRef(), req.GetPatch(), apptest.AuditService_Apply_FullMethodName)
}

func (s AuditServiceServer) apply(ctx context.Context, ref *apptest.AuditRef, doc *patchpb.Patch, by string) (*apptest.Audit, error) {
...
func (s AuditServiceServer) Erase(ctx context.Context, req *apptest.AuditRef) (*apptest.AuditEraseResponse, error) {
	...
	if n > 0 {
		if err := record(ctx, s.Rec, st.Db, Change{
			By:  apptest.AuditService_Erase_FullMethodName,
			Key: k,
		}); err != nil {
			return nil, err
		}
...
func AuditPick(req *apptest.AuditRef) (predicate.Audit, error) {
	switch req.WhichKey() {
	case apptest.AuditRef_Id_case:
		if v, err := uuid.FromBytes(req.GetId()); err != nil {
			return nil, status.Errorf(codes.InvalidArgument, "id: %s", err)
		} else {
			return audit.IdEQ(v), nil
		}
	case apptest.AuditRef_Key_not_set_case:
