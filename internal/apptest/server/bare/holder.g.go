...
type HolderServiceServer struct {
	...
	apptest.UnimplementedHolderServiceServer
}
...
func NewHolderServiceServer(db *ent.Client, opts ...Option) apptest.HolderServiceServer {
...
func (s HolderServiceServer) Add(ctx context.Context, req *apptest.HolderAddRequest) (*apptest.Holder, error) {
	...
	ds := make([]func(v *apptest.Holder), 0, 1)
...
func (s HolderServiceServer) Get(ctx context.Context, req *apptest.HolderGetRequest) (*apptest.Holder, error) {
...
func HolderSelect(q *ent.HolderQuery, m *apptest.HolderSelect) {
	if !m.GetAll() {
...
func HolderSelectInit(q *ent.HolderQuery, m *apptest.HolderSelect) {
	if m != nil {
		HolderSelect(q, m)
	} else {
...
func (s HolderServiceServer) Patch(ctx context.Context, req *apptest.HolderPatchRequest) (*apptest.Holder, error) {
	...
	return s.apply(ctx, req.GetRef(), doc, apptest.HolderService_Patch_FullMethodName)
}

func HolderGetKey(ctx context.Context, db *ent.Client, ref *apptest.HolderRef) (uuid.UUID, error) {
	var z uuid.UUID
	if ref.HasId() {
...
var holderOrmEntity = ormpatch.MustEntityOf(apptest.File_payday_holder_proto, "Holder")
...
func (s HolderServiceServer) Apply(ctx context.Context, req *apptest.HolderApplyRequest) (*apptest.Holder, error) {
	...
	return s.apply(ctx, req.GetRef(), req.GetPatch(), apptest.HolderService_Apply_FullMethodName)
}

func (s HolderServiceServer) apply(ctx context.Context, ref *apptest.HolderRef, doc *patchpb.Patch, by string) (*apptest.Holder, error) {
...
func (s HolderServiceServer) Erase(ctx context.Context, req *apptest.HolderRef) (*emptypb.Empty, error) {
	...
	if n > 0 {
		if err := record(ctx, s.Rec, st.Db, Change{
			By:  apptest.HolderService_Erase_FullMethodName,
			Key: k,
		}); err != nil {
			return nil, err
		}
...
func HolderPick(req *apptest.HolderRef) (predicate.Holder, error) {
	...
	case apptest.HolderRef_Slug_case:
		...
		return holder.And(ps...), nil
	case apptest.HolderRef_Key_not_set_case:
